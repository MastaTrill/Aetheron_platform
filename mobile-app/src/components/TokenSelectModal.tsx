...
export const TokenSelectModal: React.FC<TokenSelectProps> = ({ visible, onSelect, onClose, selected }) => {
  return (
        ...
        <View style={styles.modal}>
          ...
          <FlatList
            ...
            renderItem={({ item }) => (
              ...
              >
                <Image source={typeof item.logo === 'string' ? { uri: item.logo } : item.logo} style={styles.logo} />
...
const styles = StyleSheet.create({
  ...
  modal: { backgroundColor: theme.colors.background, borderRadius: 12, padding: 20, width: '85%', maxHeight: '80%' },
