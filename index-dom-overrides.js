...
function reconcilePublicHomepage() {
  ...
  const description = 'Explore Aetheron on Base Mainnet. V1 is the legacy deployed token; the recorded presale window has ended and refunds are available. V2 is prepared but not deployed. Canonical liquidity remains unavailable until a verified Base pool is published.';
  ...
  if (faqAnswers[2]) faqAnswers[2].innerHTML = '<p>The legacy V1 contract stores historical 3% buy and 5% sell settings, but no canonical Base DEX pool is configured. The prepared V2 candidate uses standard ERC-20 transfers with no transfer tax.</p>';
