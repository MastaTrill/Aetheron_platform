...
class AetheronMonitor {
  constructor() {
    ...
    this.links = {
      buy: 'https://basescan.org/address/0xe0A3B6368312dFd3E7E76202e673f895f8235A3d#writeContract',
  ...
  injectStyles() {
    ...
    style.textContent = `
      .aetheron-live-banner{display:grid;grid-template-columns:1.15fr 2fr auto;gap:16px;align-items:center;margin:20px auto;padding:18px;border-radius:20px;border:1px solid rgba(251,191,36,.4);background:linear-gradient(135deg,rgba(7,24,39,.96),rgba(46,20,101,.84));box-shadow:0 22px 50px rgba(0,0,0,.28);color:#fff}
      ...
      .aetheron-live-banner__headline{display:flex;align-items:center;gap:10px;font-size:1.14rem;font-weight:800}.aetheron-live-banner__dot{width:11px;height:11px;border-radius:50%;background:#f59e0b;box-shadow:0 0 18px rgba(245,158,11,.8)}
  ...
  renderPresaleBanner() {
    ...
    banner.innerHTML = `
      <div class="aetheron-live-banner__status"><div class="aetheron-live-banner__eyebrow">Sale status</div><div class="aetheron-live-banner__headline"><span class="aetheron-live-banner__dot"></span><span>BASE PRESALE ENDED</span></div><div class="aetheron-live-banner__eyebrow">Soft cap missed. Purchases closed. Refunds via claimRefund().</div></div>
      <div class="aetheron-live-banner__meta">
        <div class="aetheron-live-banner__metric"><div class="aetheron-live-banner__metric-label">Raised</div><div class="aetheron-live-banner__metric-value">0.0049 ETH</div></div>
        <div class="aetheron-live-banner__metric"><div class="aetheron-live-banner__metric-label">Soft cap</div><div class="aetheron-live-banner__metric-value">5 ETH missed</div></div>
